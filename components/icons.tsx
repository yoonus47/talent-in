/**
 * lucide-react (this app's icon set everywhere else) dropped all brand
 * icons years ago — Instagram/Youtube/Github aren't in it. Rather than add
 * a whole extra icon package for three glyphs, these are inlined,
 * matching lucide's own API shape (className prop, currentColor,
 * 24x24 viewBox) so they drop in anywhere a lucide icon would.
 */
