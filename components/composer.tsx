...
export function Composer({
  ...
  profile: Profile;
  /** Pre-fills the textarea (still fully editable, not auto-posted) —
   * used by the community "Share to feed" crosspost link
   * (app/feed/page.tsx's own searchParams.prefill). */
