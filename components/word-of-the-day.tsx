 ...
 * The word and a pronunciation button are always visible ("hear it before
 * you're quizzed"); tapping the strip below reveals the definition and
 * example, Duolingo-style. Audio is a British-female clip generated by
        ...
        <div className="flex items-center gap-2.5">
          ...
          {word.audio_url && (
            <button
              ...
              className={cn(
                "flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-border text-muted-foreground transition-colors hover:bg-muted",
